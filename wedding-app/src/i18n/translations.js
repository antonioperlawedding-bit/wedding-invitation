export const translations = {
  en: {
    ...
    chatbot: {
      ...
      q1: 'Tell me about the groom',
      q2: 'Tell me about the bride',
      q3: "What's the dress code?",
      q4: 'Where is the ceremony?',
  ...
  ar: {
    ...
    chatbot: {
      ...
      q1: 'أخبرني عن العريس',
      q2: 'أخبرني عن العروس',
      q3: 'ما هو الزي المطلوب؟',
      q4: 'أين تُقام مراسم الزفاف؟',
      q5: 'في أي وقت يجب أن أصل؟',
      q6: 'هل يتوفر موقف للسيارات؟',
      q7: 'كيف أؤكد حضوري؟',
